...
valider1.onclick = function calculateResults() {
    ...
    if (isNaN(scoreTeam1)) {
        alert('Please enter a valid score for Team 1.');
        return;
    }

    totalTeam1 += scoreTeam1;
    resultat1.innerHTML = `Resultat 1: ${totalTeam1}`;
    inputTeam1.value = ''; // Clear the input field after calculation
    if (totalTeam1>=100 ){
        scoretotal.innerText = 'Team 1 Gagne !!'
        myAudio.play();
    };
...
valider2.onclick = function calculateResultsTeam2() {
    ...
    if (isNaN(scoreTeam2)) {
        alert('Please enter a valid score for Team 2.');
        return;
    }

    totalTeam2 += scoreTeam2;
    resultat2.innerHTML = `Resultat 2: ${totalTeam2}`;
    inputTeam2.value = ''; // Clear the input field after calculation

    if (totalTeam2>=100 ){
        scoretotal.innerText = 'Team 2 Gagne !!'
        myAudio.play();
    };
...
resetButton.onclick = function resetScores() {
    ...
    resultat1.innerHTML = 'Resultat 1: 0';
    resultat2.innerHTML = 'Resultat 2: 0';
